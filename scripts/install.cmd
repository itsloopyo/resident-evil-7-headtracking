...
set "MOD_CONTROLS=Controls:&echo   Home - Recenter head tracking&echo   End  - Toggle head tracking on/off&echo   PgUp - Cycle tracking mode (full/rotation/position)&echo   PgDn - Toggle world/local yaw"
