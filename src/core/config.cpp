...
void Config::Validate() {
    ...
    localSmoothing = SanitizeFinite(localSmoothing, kDefaults.localSmoothing, 0.0f, 1.0f);
    remoteSmoothing = SanitizeFinite(remoteSmoothing, kDefaults.remoteSmoothing, 0.0f, 1.0f);
